About saml-auth-proxy-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/saml-auth-proxy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/saml-auth-proxy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add saml-auth-proxy
# for installing globally
pixi global install saml-auth-proxy
```
...
It is possible to list all of the versions of `saml-auth-proxy` available on your platform:
...
```
pixi search saml-auth-proxy --channel conda-forge
```
